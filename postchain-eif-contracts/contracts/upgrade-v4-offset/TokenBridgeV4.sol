...
/// @notice
/// TokenBridgeV4 is identical to TokenBridge except TokenBridgeV4 has a second initializer to support updating the withdrawOffset variable once.
...
contract TokenBridgeV4 is Initializable, PausableUpgradeable, Ownable2StepUpgradeable, ReentrancyGuardUpgradeable {
    ...
    event InitializeV4(uint256 _withdrawTimeOffset);
    ...
    /**
     * @dev Initialize V4 with withdraw time offset
     * @param _withdrawTimeOffset The time offset for withdrawals in seconds. Must be greater than 0.
     * @custom:oz-upgrades-validate-as-initializer
     */
    function initializeV4(uint256 _withdrawTimeOffset) public reinitializer(4) {
        require(version == 3, "TokenBridgeV4: not initialized as version 3");
        require(_withdrawTimeOffset > 0, "TokenBridgeV4: withdraw time offset must be greater than 0");
        withdrawTimeOffset = _withdrawTimeOffset;
        version = 4;
        emit InitializeV4(_withdrawTimeOffset);
    }
