...
Ethereum Interoperability Framework (EIF) -- a set of components that power Chromia-Ethereum interoperability 
by importing events, generating verifiable proofs, managing state, and submitting transactions.
