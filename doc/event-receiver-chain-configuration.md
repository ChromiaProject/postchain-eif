...
| `skip_to_height`     | The block number from which the Event Receiver will start querying events. This will be the lower bound for any contract. See note and table below for details.                                                                | int           |                    | 0       |
...
**Note:** EIF adjusts its **current height** only when a *new* or *re-added* contract with no processed events introduces a *lower* `skip_to_height`. Updating `skip_to_height` on an existing contract never changes the current height. When `skip_to_height` is decreased, EIF resumes processing from the lower height and ignores events from each contract that precede its latest processed event, ensuring data consistency.


| Scenario                              | `skip_to_height` change | Effect on current height                                                                                                                                                                               |
|---------------------------------------|-------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Contract updated                      | Lower / Higher          | No change                                                                                                                                                                                              |
| Re-added contract (after removal)     | Lower                   | Decreases — rereads contract events from lower `skip_to_height` if no events processed, otherwise no change                                                                                            |
|                                       | Higher                  | No change                                                                                                                                                                                              |
| Contract removed, new contract added  | Lower                   | Decreases — processes blocks and new contract events starting from lower `skip_to_height`, ignores events from removed contracts for data consistency                                                  |
|                                       | Higher                  | No change                                                                                                                                                                                              |
| New contract added                    | Lower                   | Decreases — processes blocks and new contract events starting from the lower `skip_to_height`, ignores events from each existing contract that precede its latest processed event for data consistency |
|                                       | Higher                  | No change                                                                                                                                                                                              |
