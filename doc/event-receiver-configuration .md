...
| `evm.connectTimeout`          | The connect timeout for TCP connections, in seconds (see OkHttpClient docs)                                                              | int          | 300     | `POSTCHAIN_EIF_EVM_CONNECT_TIMEOUT`            |
| `evm.readTimeout`             | The read timeout for TCP connections, in seconds (see OkHttpClient docs)                                                                 | int          | 300     | `POSTCHAIN_EIF_EVM_READ_TIMEOUT`               |
| `evm.writeTimeout`            | The write timeout for TCP connections, in seconds (see OkHttpClient docs)                                                                | int          | 300     | `POSTCHAIN_EIF_EVM_WRITE_TIMEOUT`              |
