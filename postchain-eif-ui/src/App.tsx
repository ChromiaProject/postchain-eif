				...
				<div className="App">
					...
					<div className="form-control">
						<label className="label">
							<span className="label-text">Pick the network</span>
						</label>
						...
						<label className="label">
							<span className="label-text">Pick the token</span>
						</label>
					...
					{chainId == 5 && !!tokenAddress && !!goerliBridgeAddress && (
						<Bridge bridgeAddress={goerliBridgeAddress} tokenAddress={tokenAddress} />
					)}
					
					{chainId == 97 && !!tokenAddress && !!bscBridgeAddress && (
						<Bridge bridgeAddress={bscBridgeAddress} tokenAddress={tokenAddress} />
					)}
					
					{chainId == 80001 && !!tokenAddress && !!mumbaiBridgeAddress && (
						<Bridge bridgeAddress={mumbaiBridgeAddress} tokenAddress={tokenAddress} />
					)}
				</div>
